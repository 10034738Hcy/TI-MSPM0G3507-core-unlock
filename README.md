...
**官方 LaunchPad 板**
  ...
  官方 LP-MSPM0G3507 的 BOOT 键是 S1(PA18)。用我这个工具的 XDS110 LaunchPad 模式时，正常不需要手动按 BOOT，工具会通过 XDS110 控制进入 BSL。

**最小系统板 / 自己画的板**
  推荐用 手动串口 模式，接普通 USB-TTL：
  ...
  4. 在工具里选 手动串口，选择 USB-TTL 对应 COM 口。
  5. 尽快点 开始烧录，本地资料提醒进入 BSL 后最好 5 秒内开始下载。
